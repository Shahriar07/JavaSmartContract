...
public interface DocumentStateList {
     ...
     */
    static DocumentStateList getStateList(Context ctx, String listName, StateDeserializer deserializer) {
        return new DocumentStateListImpl(ctx, listName, deserializer);
    }
